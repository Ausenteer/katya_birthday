  ...
  return (
    <section className="section final reveal" id="final" ref={revealRef}>
      <div className="final__card">
        ...
        <h2>Катя, с днём рождения ♡</h2>
        <p>
          Говорят, с возрастом мир расколдовывается. Особенно у BI-аналитиков: у всего есть
          причина, следствие и, если очень повезёт, дашборд. Любое «чудо» раскладывается на
          метрики, а необъяснимое — это просто то, к чему ещё не подвели данные.
        </p>
        <p>
          Но мы, как видишь, построили целый сайт вопреки этому. Придумали тебе таро, нарисовали
          дашборд судьбы, честно посчитали в твоём составе бегемотиков Kinder, и вообще-то ни
        ...
        <p>
          ...
          всё, что попадалось по дороге. Поэтому желаем тебе не «настоящих чудес», ты сама их
