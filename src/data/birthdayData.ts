...
export const sections = [
  ...
  { id: 'album', label: 'Альбом', number: '05' },
...
export const dressUpPresets = [
  {
    ...
    items: ['Свитер с лимонами', 'Чёрные брюки', 'Ноутбук', 'Рабочий бейджик', 'Кружка кофе'],
...
export const loveReasons = [
  ...
  'За то, как ты шутишь и как смеёшься над нашими шутками',
