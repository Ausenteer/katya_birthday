...
export const loveFacts = [
  'За то, как ты принимаешь комплименты',
  'За то, как ты шутишь и как смеешься над нашими шутками',
  'За твой ум - тот самый, который находит инсайты там, где остальные видят кучу хаотичных данных',
  'За эмпатию и желание понять, даже если твой опыт отличается',
  'За дружелюбие и легкость',
  'За то, что с тобой всегда интересно',
];
